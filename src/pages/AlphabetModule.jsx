    ...
    <div ref={containerRef} className="flex-1 flex flex-col items-center p-1 md:p-4 w-full max-w-7xl mx-auto min-h-screen lg:h-screen lg:overflow-hidden overflow-y-auto">
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          exit={{ x: -50, opacity: 0 }}
          className="bg-white/80 backdrop-blur-md rounded-[2rem] md:rounded-[3rem] p-3 md:p-8 shadow-2xl border-b-8 border-brand-red w-full flex flex-col lg:flex-1 overflow-y-auto lg:overflow-visible"
        >
